...
Installing rubin-sim
====================

Installing `rubin-sim` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Updating rubin-sim-feedstock
============================

If you would like to improve the rubin-sim recipe or build a new
...
Note that all branches in the conda-forge/rubin-sim-feedstock are
